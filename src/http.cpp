...
#ifdef DREAMCAST
#define USER_AGENT "DreamZZT/3.0.8 (Dreamcast)"
#endif
#if TIKI_PLAT == TIKI_SDL
#define USER_AGENT "DreamZZT/3.0.8 (Linux)"
#endif
#if TIKI_PLAT == TIKI_WIN32
#define USER_AGENT "DreamZZT/3.0.8 (Windows)"
#endif
#if TIKI_PLAT == TIKI_OSX
#define USER_AGENT "DreamZZT/3.0.8 (Macintosh)"
#endif
